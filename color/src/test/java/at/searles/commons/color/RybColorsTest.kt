...
class RybColorsTest {
    ...
    @Test
    fun color() {
        Assert.assertEquals(0xffff0000.toInt(), RybColors.color(0F))
        Assert.assertEquals(0xff00ff00.toInt(), RybColors.color(0.5F))
        Assert.assertEquals(0xffff0000.toInt(), RybColors.color(1F))
    }
